...
- [/] Responsive สำหรับ Mobile/Tablet (ใช้ในสนาม)
    - [x] เพิ่ม class `.wrap-mobile` ใน `style.css`
    - [/] แก้ไข UI ช่องค้นหาในหน้าทะเบียนราษฎร (Villager List) สำหรับมือถือ
        - [ ] ลบ inline style `flex:1` ออก
        - [ ] ปรับแก้ CSS ให้ `.search-bar` ขยายตัวได้เต็มที่และไม่ถูกเบียด
        - [ ] ปรับปรุงการจัดวางปุ่มค้นหาและตัวกรองให้เป็นระเบียบเมื่อจอเล็กลง
- [ ] ทดสอบครบวงจร
